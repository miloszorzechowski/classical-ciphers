...
public abstract class CipherGenerator {
    ...
    protected void isLetter(char character) throws unknownCharacterException {
        if (!Character.isLetter(character)) {
            throw new unknownCharacterException(String.format("Character \"%c\" is not part of the alphabet", character));
        }
    }
